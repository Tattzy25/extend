...
export function GeneratedImagesGrid({
  ...
  const iconCommon =
    "h-7 w-7 [&>svg]:[filter:drop-shadow(0_1px_2px_rgba(255,255,255,0.6))_drop-shadow(0_1px_3px_rgba(0,0,0,0.25))]"
  const tooltipClass =
          ...
          <div key={i} className="flex flex-col gap-2 group">
            ...
            <div className="flex justify-center gap-1 min-h-[44px] items-center" data-slot="individual-actions">
              ...
              >
                ...
                <Heart
                  className={`${iconCommon} fill-red-600 stroke-red-700 filter-[drop-shadow(0_1px_2px_rgba(255,255,255,0.4))_drop-shadow(0_2px_4px_rgba(0,0,0,0.3))]`}
                  aria-hidden="true"
                />
              </button>
              <button
